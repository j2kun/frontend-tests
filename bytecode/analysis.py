...
Ported from numba/core/byteflow.py
"""
...
from numba.core.controlflow import CFGraph, NEW_BLOCKERS
...
class TraceRunner(object):
  ...
  def op_GEN_START(self, state, inst):
    """Pops TOS. If TOS was not None, raises an exception.

    The kind operand corresponds to the type of generator or coroutine and
    determines the error message. The legal kinds are 0 for generator, 1 for
    coroutine, and 2 for async generator.
