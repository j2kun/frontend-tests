...
from bytecode.numba.core import types, errors, ir, consts
from bytecode.numba.misc import special
...
def dead_branch_prune(func_ir, called_args):
    ...
    """
    from bytecode.numba.core.ir_utils import (get_definition, guard, find_const,
                                     GuardException)
...
def find_literally_calls(func_ir, argtypes):
    ...
    argtypes : Sequence[numba.types.Type]
        The argument types.
    """
    from bytecode.numba.core import ir_utils
