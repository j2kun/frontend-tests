...
from bytecode.numba.core.analysis import compute_cfg_from_blocks, find_top_level_loops
from bytecode.numba.core import errors, ir, ir_utils
from bytecode.numba.core.analysis import compute_use_defs, compute_cfg_from_blocks
...
def _loop_lift_modify_blocks(func_ir, loopinfo, blocks,
    ...
    """
    from bytecode.numba.core.dispatcher import LiftedLoop
...
def _pre_looplift_transform(func_ir):
    ...
    """
    from bytecode.numba.core.postproc import PostProcessor
...
def with_lifting(func_ir, typingctx, targetctx, flags, locals):
    ...
    """
    from bytecode.numba.core import postproc

    def dispatcher_factory(func_ir, objectmode=False, **kwargs):
        from bytecode.numba.core.dispatcher import LiftedWith, ObjModeLiftedWith
