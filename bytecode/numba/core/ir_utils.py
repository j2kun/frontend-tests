...
from bytecode.numba.core.errors import (TypingError, UnsupportedError,
...
def has_no_side_effect(rhs, lives, call_table):
    ...
    """
    from bytecode.numba.parfors import array_analysis, parfor
    from bytecode.numba.misc.special import prange
...
def compile_to_numba_ir(mk_func, glbls, typingctx=None, targetctx=None,
    ...
    calltypes.
    """
    from bytecode.numba.core import typed_passes
...
def get_ir_of_code(glbls, fcode):
    ...
    from bytecode.numba.core import compiler
    ...
    import bytecode.numba.core.inline_closurecall
    ...
    from bytecode.numba.core.untyped_passes import ReconstructSSA
    from bytecode.numba.core.typed_passes import PreLowerStripPhis
