...
from bytecode.numba.core.config import (PYVERSION, MACHINE_BITS, # noqa: F401
                               DEVELOPER_MODE) # noqa: F401
from bytecode.numba.core import config
from bytecode.numba.core import types
...
def _warn_old_style():
    from bytecode.numba.core import errors  # to prevent circular import
...
def order_by_target_specificity(target, templates, fnkey=''):
    ...
    from bytecode.numba.core.target_extension import target_registry
    ...
    if not order:
        ...
        from bytecode.numba.core.errors import UnsupportedError
...
def unified_function_type(numba_types, require_precise=True):
    ...
    """
    from bytecode.numba.core.errors import NumbaExperimentalFeatureWarning
...
class _RedirectSubpackage(ModuleType):
    ...
    >>> from bytecode.numba.old_subpackage import module
    >>> module.item

    >>> import bytecode.numba.old_subpackage.module
    >>> numba.old_subpackage.module.item

    >>> from bytecode.numba.old_subpackage.module import item
    """
...
def dump_llvm(fndesc, module):
    ...
    if config.HIGHLIGHT_DUMPS:
        try:
            ...
            from bytecode.numba.misc.dump_style import by_colorscheme
