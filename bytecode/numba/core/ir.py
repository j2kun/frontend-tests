...
from bytecode.numba.core import errors, config
from bytecode.numba.core.utils import (BINOPS_TO_OPERATORS, INPLACE_BINOPS_TO_OPERATORS,
                              UNARY_BUITINS_TO_OPERATORS, OPERATORS_TO_BUILTINS)
from bytecode.numba.core.errors import (NotDefinedError, RedefinedError,
                               VerificationError, ConstantInferenceError)
from bytecode.numba.core import consts
        ...
        if nofile:
            ...
            if config.HIGHLIGHT_DUMPS:
                try:
                    ...
                    from bytecode.numba.misc.dump_style import NumbaIRLexer as lexer
